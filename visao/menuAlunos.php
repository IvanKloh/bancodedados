...
<title>Menu Alunos</title>
	...
	<div class="menu">
			...
			<div class="lista">
			  ...
			  <a href="<?php echo "http://".$server."/aulasenac/bancodedados/visao/"?>listarAlunos.php">
			  <i class="fa fa-list-ul" aria-hidden="true"></i>
			   Listar</a>
			</div>   
			<div class="cadastra">
			   <a href="<?php echo "http://".$server."/aulasenac/bancodedados/visao/"?>insereAlunos.php">
			  <i class="fa fa-database" aria-hidden="true"></i>
			   Inserir </a>
			 </div>  
			<div class="busca">
			  <a href="<?php echo "http://".$server."/aulasenac/bancodedados/visao/"?>buscarAlunos.php">
