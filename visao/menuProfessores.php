	...
	<div class="menu">
			<div id="banner"title="Meu Baner" onclick="inicio('<?php echo $server?>');">
		 	...
		 	<div class="lista">
			  ...
			  <a href="<?php echo "http://".$server."/aulasenac/bancodedados/visao/"?>listarProfessores.php">
			  <i class="fa fa-list-ul" aria-hidden="true"></i>
			   Listar</a>
			</div>   
			<div class="cadastra">
			   <a href="<?php echo "http://".$server."/aulasenac/bancodedados/visao/"?>insereProfessores.php">
			  <i class="fa fa-database" aria-hidden="true"></i>
			   Inserir </a>
			 </div>  
			<div class="busca">
			  <a href="<?php echo "http://".$server."/aulasenac/bancodedados/visao/"?>buscarProfessores.php">
